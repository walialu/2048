...
window.requestAnimationFrame(function () {
  ...
  "general": {
    ...
    "how_to_text_short": "<strong>How to play:</strong> To move the tiles in a particular direction use the <strong>arrow keys</strong> (up, down, right, left). If two tiles with the same number collide, they merge into one tile with the sum of their numbers (so two 4 tiles merge to form one 8 tile etc). The objective is to form a tile with the number <strong>2048</strong>. The game ends when all the fields are covered with tiles. ",
